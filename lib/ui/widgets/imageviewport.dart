...
import 'package:perumahan/ui/widgets/map_object.dart';
import 'package:perumahan/ui/widgets/map_painter.dart';
...
class _ImageViewportState extends State<ImageViewport> with TickerProviderStateMixin {
  double _zoomLevel;
  ...
  void _updateActualImageDimensions() {
    _actualImageSize = Size((_image.width / window.devicePixelRatio) * _zoomLevel,
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: FadeTransition(
                          opacity: _animation,
                          child: Container(
                            width: object.size == null ? null : (object.size.width * _zoomLevel) / 2,
                            height: object.size == null ? null : (object.size.height * _zoomLevel) / 2,
                            child: object.label,
                          ),
                        ),
                      )
